			...
			<div className="space-y-3">
				...
				>
					<div className="flex items-center space-x-2">
						...
						<Label htmlFor="asc" className="text-sm">Ascending</Label>
					</div>
					<div className="flex items-center space-x-2">
						<RadioGroupItem value="desc" id="desc" />
						<Label htmlFor="desc" className="text-sm">Descending</Label>
					</div>
				</RadioGroup>
			</div>
				...
				<div className="space-y-3 pt-4">
					...
					<div className="flex flex-wrap gap-2">
						{Object.entries(filters).map(([key, value]) => {
							...
							if (shouldShow) {
								return (
									<Badge onClick={() => removeFilter(key as keyof FilterState)} key={key} variant="secondary" className="flex items-center gap-1">
